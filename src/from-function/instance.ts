...
export type CurryOnFunction<OgParams extends BaseParams, OgResult> = {
...
export const fromFunction = <OgParams extends BaseParams, OgResult>(
    rootFunc: BaseFunc<OgParams, OgResult>
) => {
    const instance: CurryOnFunction<OgParams, OgResult> = (
        ...params: OgParams
    ) => rootFunc(...params)
